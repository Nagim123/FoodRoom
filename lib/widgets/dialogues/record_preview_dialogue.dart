...
Future<void> showFoodPreview(BuildContext context, FoodRecord foodToShow,
    RecordCluster recordCluster, DayRecording dayRecording) async {
  showDialog(
    barrierColor: const Color.fromARGB(200, 0, 0, 0),
    context: context,
    builder: (BuildContext context) => RecordPreviewPage(
      foodRecord: foodToShow,
